...
const LandingKinerja = () => {
  ...
  const getDataIsu = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      `SELECT a.id,a.thang,a.kddept,b.nmdept,a.periode,a.username,a.isu,a.createdAt 
      FROM laporan_2023.isu a LEFT JOIN dbref.t_dept_2023 b 
      ON a.kddept=b.kddept 
      WHERE a.thang='${inputValues.thang}' AND a.kddept='${inputValues.dept}' AND a.periode='${inputValues.periode}'
`
    );
  ...
  const getDataTren = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      `SELECT 'tren_dukman' AS tabel, thang, kddept, periode, username, isu, createdAt, updatedAt
      FROM laporan_2023.tren_dukman WHERE thang='${inputValues.thang}' AND kddept='${inputValues.dept}' AND periode='${inputValues.periode}'
      UNION ALL
      SELECT 'tren_jenbel' AS tabel, thang, kddept, periode, username, isu, createdAt, updatedAt
      FROM laporan_2023.tren_jenbel WHERE thang='${inputValues.thang}' AND kddept='${inputValues.dept}' AND periode='${inputValues.periode}' 
      UNION ALL
      SELECT 'tren_bulanan' AS tabel, thang, kddept, periode, username, isu, createdAt, updatedAt
      FROM laporan_2023.tren_bulanan WHERE thang='${inputValues.thang}' AND kddept='${inputValues.dept}' AND periode='${inputValues.periode}'  
      UNION ALL
      SELECT 'tren_sdana' AS tabel, thang, kddept, periode, username, isu, createdAt, updatedAt
      FROM laporan_2023.tren_sdana WHERE thang='${inputValues.thang}' AND kddept='${inputValues.dept}' AND periode='${inputValues.periode}'  
      UNION ALL
      SELECT 'tren_uptup' AS tabel, thang, kddept, periode, username, isu, createdAt, updatedAt
      FROM laporan_2023.tren_uptup WHERE thang='${inputValues.thang}' AND kddept='${inputValues.dept}' AND periode='${inputValues.periode}'      
  ...
  const getDataOutput = async () => {
    setLoading(true);
    const encodedQuery = encodeURIComponent(
      `SELECT b.id as idedit,a.username, a.createdAt,a.id_output,a.thang,a.kddept,a.periode,a.namaoutput,a.catatan,b.tahun,b.pagu,b.realisasi,b.persen FROM laporan_2023.output a
      LEFT JOIN laporan_2023.output_detail b ON a.id_output=b.id_output WHERE a.thang='${inputValues.thang}' AND a.kddept='${inputValues.dept}' AND a.periode='${inputValues.periode}'
      `
    );
  ...
  const getDataTemuan = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      `  SELECT a.id_temuan, a.id idtemuan, b.id iddetailtemuan, a.isu temuan,a.nilai,b.isu,a.id_temuan,a.username,a.createdAt FROM laporan_2023.temuan_bpk a
      LEFT JOIN laporan_2023.temuan_bpk_detail b ON a.id_temuan=b.id_temuan WHERE a.thang='${inputValues.thang}' AND a.kddept='${inputValues.dept}' AND a.periode='${inputValues.periode}'
      `
    );
  ...
  const getDataIkpa = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      `SELECT a.id,a.thang,a.kddept,a.periode,a.username,a.nilaiikpa,a.createdAt from laporan_2023.tren_ikpa a
      WHERE  a.kddept='${inputValues.dept}' AND a.periode='${inputValues.periode}' order by a.thang
      `
    );
  ...
  return (
    <>
      ...
      >
        ...
        {/* {cek2 ? (
          <Button variant="success" size="sm" className="my-2 mx-2" disabled>
            <Spinner
              as="span"
              animation="grow"
              size="sm"
          ...
          <Row>
            <Col xs={12} md={9} lg={9} xl={9}>
              ...
              >
                <Col xs={12} md={12} lg={2} xl={2}>
                  <div className="logokl">
                    {datadept
                      .filter((item) => item.kddept === inputValues.dept)
                      .map((filteredItem, index) => (
                        ...
                        >
                          <Image
                            src={`/logo/${filteredItem.kddept}.png`}
                            alt="no-logo"
                            onError={(e) => {
                              e.target.onerror = null;
                              e.target.src = "/logo/null.png";
                            }}
                          />
                          ...
                          <div
                            ...
                            style={{
                              fontSize: "15px",
                              padding: "10px", // Ubah margin top sesuai kebutuhan
                              fontWeight: "bold",
                              textAlign: "center", // Tambah properti textAlign: "center"
                            }}
                          >
                            {filteredItem.nmdept.length > 0
                              ? `${filteredItem.nmdept.slice(0, 80)}`
                              : filteredItem.nmdept}
                          </div>
                        </div>
                      ))}
              ...
              <Row>
                <Col xs={12} md={4} lg={4} xl={4}>
                  <Card className="card-kinerja" onClick={handleShowTren}>
                    <Card.Body>
                      <ChartDukman
              ...
              <Row>
                <Col xs={12} md={4} lg={4} xl={4}>
                  <Card className="card-kinerja-ikpa">
                    <Card.Body>
                  ...
                  <Card>
                    ...
                    >
                      {loading ? (
                        ...
                        <>
                          {" "}
                          <div className="header-kinerja d-flex justify-content-center">
                            Temuan BPK{" "}
                            <i
            ...
            <Col xs={12} md={3} lg={3} xl={3}>
              <Card className="card-output1 mt-2">
                <Card.Body>
                  <div className="header-kinerja-kanan d-flex justify-content-between">
