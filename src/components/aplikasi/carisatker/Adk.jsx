...
const Adk = (props) => {
  ...
  const getData = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      "SELECT kddept,kdunit,kdsatker,kddekon,norev,tg,jam,size,nmfile,folder,fileorpdf FROM monev2023.ftp_dipa_list_2023 WHERE kdsatker='" +
        props.kdsatker +
          ...
          {loading ? (
            ...
            <>
              <Card style={{ height: "375px", overflow: "scroll" }}>
                <Card.Body>
                  <Card.Title>
                    <h5 className="card-title">DIPA TA. 2023</h5>
                  </Card.Title>
                  <Table
                    size="sm"
