...
const Adk2022 = (props) => {
  ...
  const getData = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      "SELECT kddept,kdunit,kdsatker,kddekon,norev,tg,jam,size,nmfile,folder,fileorpdf FROM monev2022.ftp_dipa_list_2022 WHERE kdsatker='" +
        props.kdsatker +
          ...
          {loading ? (
            ...
            <>
              <Card style={{ height: "375px", overflow: "scroll" }}>
                <Card.Body>
                  <Card.Title>
                    <h5 className="card-title">DIPA TA. 2022</h5>
                  </Card.Title>
                  <Table
                    size="sm"
