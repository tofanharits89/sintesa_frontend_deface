...
import KdkmkTransaksi25 from "../../referensi/referensi_dau25/ref_kmktransaksi";
import Kdkriteria25 from "../../referensi/referensi_dau25/ref_kriteria";
import RefPemotongan25 from "../../referensi/referensi_dau25/ref_pemotongan";
import RefAkun25 from "../../referensi/referensi_dau25/ref_akun";
import RefPenundaanTransaksi25 from "../../referensi/referensi_dau25/ref_penundaan_transaksi";

const RekamDataTransaksi25 = ({ show, onHide, id, thang }) => {
  ...
  const getData = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      ...
      FROM 
          tkd25.m_transaksi A
      left JOIN 
          tkd25.detail_kmk_dau B ON A.bulan = B.bulan AND A.kdkppn = B.kdkppn
  ...
  const handleSubmitdata = async (values, { setSubmitting }) => {
    ...
    try {
      await axiosJWT.post(
        import.meta.env.VITE_REACT_APP_SIMPANPENCABUTAN_25,
        values,
        {
          headers: {
            Authorization: `Bearer ${token}`,
...
export default RekamDataTransaksi25;
