  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await axiosJWT.get(
        import.meta.env.VITE_REACT_APP_LOCAL_INQUIRYTKD_CSV
          ? `${import.meta.env.VITE_REACT_APP_LOCAL_INQUIRYTKD_CSV}${encodedQuery}`
          : "",
        {
          headers: {
...
export default GenerateExcel135;
