...
import JenisLaporanKontrak from "../../referensi/JenisLaporanKontrak";
...
import HasilQueryKontrak from "./hasilQueryKontrak";
...
import JenisKontrak from "./jenisKontrak";
import JeniskontrakRadio from "../inquiry/radio/jeniskontrakRadio";
...
const InquiryKontrak = () => {
  ...
  const handleCutoffcek = () => {
    let selectkontrak =
      ", nokontrak, tgkontrak, tgterima, termin_ke, tgljatuhtempo as tgljatuhtempo_termin, tgljatuhtempo, deskripsi,  ROUND(SUM(CONVERT(a.pagu, SIGNED))/" +
      pembulatan +
      ",0) AS PAGU_KONTRAK";

    let selectkontrakvalas =
      ", currency, kurs_user, nokontrak, tgkontrak, tgterima, termin_ke, tgljatuhtempo as tgljatuhtempo_termin, tgljatuhtempo, deskripsi, ROUND(SUM(CONVERT(a.pagu, SIGNED))/" +
      pembulatan +
      ",0) AS PAGU_KONTRAK";
    ...
    let from = "monev" + thang + ".pa_kontrak_" + thang + "_baru a";
    ...
    if (cutoff === "1") {
      switch (jenlap) {
        ...
        case "2":
          setFrom(from);
          setSelect(selectkontrakvalas + real);
          break;
        default:
          break;
      }
  ...
  const [kdjeniskontrak, setKdJeniskontrak] = useState(false);
  const [jeniskontrakradio, setJeniskontrakradio] = useState("1");
  const [jeniskontrak, setJeniskontrak] = useState("XX");
  const handleKdJeniskontrak = (jeniskontrak) => {
    setKdJeniskontrak(jeniskontrak);
    setJeniskontrak(jeniskontrak);
  };
  const getSwitchJeniskontrak = (kdjeniskontrak) => {
    if (kdjeniskontrak) {
      setJeniskontrak("00");
    } else {
      setJeniskontrak("XX");
    }
    setKdJeniskontrak(kdjeniskontrak);
  };
  const handleRadioJeniskontrak = (jeniskontrakRadio) => {
    setJeniskontrakradio(jeniskontrakRadio);
  };
    ...
    <>
                ...
                <Card.Body>
                  <div className="bagian-query">
                    ...
                    <Row>
                      ...
                      <Col xs={6} md={6} lg={6} xl={3}>
                        <pilihanData.SwitchJeniskontrak
                          onChange={getSwitchJeniskontrak}
                        />
                      </Col>
                    </Row>
                ...
                <Card.Body>
                  ...
                  {kdjeniskontrak && (
                    <>
                      <Row className="mt-2">
                        <Col xs={4} sm={4} md={4}>
                          <span className="middle  ">Jenis Kontrak</span>
                        </Col>

                        <Col xs={4} sm={4} md={4}>
                          <JenisKontrak onChange={handleKdJeniskontrak} />
                        </Col>
                        <Col xs={4} sm={4} md={4}>
                          <JeniskontrakRadio
                            jeniskontrakRadio={handleRadioJeniskontrak}
                            selectedValue={jeniskontrakradio}
                          />
                        </Col>
                      </Row>
                    </>
      ...
      {loadingExcell && (
        <GenerateExcel
          ...
          namafile={`v3_EXCELL_KONTRAK_JENIS_${jenlap}_${moment().format(
            "DDMMYY-HHmmss"
          )}.xlsx`}
        />
      )}
      ...
      <SaveUserData userData={telp} menu="kontrak" />
    </>
  );
};
