...
import JenisLaporanBelwil from "./JenisLaporanBelwil";
import HasilQueryBelwil from "./hasilQueryBelwil";
import JenisLokasiData from "./JenisLokasiData";
...
import pilihanData from "./pilihanDataBelwil";
import { getSQL } from "./SQLBelwil";
import ThangBelwil from "../../referensi/ThangBelwil";

import PembulatanBelwil from "./PembulatanBelwil";
...
const BelanjaWilayah = () => {
    ...
    useEffect(() => {
        handleCutoffcek();
    }, [thang, cutoff, pembulatan, jenlap, jenis_lokasi, akumulatif, select, tanggal]);
    ...
    const handleCutoffcek = () => {
        ...
        let fromwil =
            "kewilayahan_" + thang + ".belanja_kewilayahan_" + thang + " a";
        // QUERY BELANJA
        ...
        if (cutoff === "1") {
            switch (jenlap) {
                ...
                case "2":
                    ...
                    jenlap === "2" && akumulatif
                        ? setSelect(realwilbulananakumulatif)
                        : setSelect(realwilbulanan);
                    break;
                default:
                    break;
            }
        ...
        <>
                ...
                <div className="pagetitle">
                    ...
                    <nav>
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">Spasial</li>
                            {/* {sql} */}
                        </ol>
                    </nav>
                </div>
                                        ...
                                        <Card.Body>
                                            <Row>
                                                <Col xs={2} sm={2} md={2} className="my-2">
                                                    <span className="fade-in ">Jenis Lokasi</span>
                                                </Col>

                                                <Col xs={4} sm={4} md={4} className="my-2">
                                                    <JenisLokasiData
                                                        value={jenis_lokasi}
                                                        onChange={handleJnslokasi}
                                                    />
                                                </Col>
                                            </Row>
                                        </Card.Body>
            ...
            {export2 && (
                <GenerateCSV
                    query3={sql}
                    status={handleStatus}
                    namafile={`v3_CSV_BELANJA_KEWILAYAHAN_${moment().format("DDMMYY-HHmmss")}`}
                />
            )}{" "}
            {loadingExcell && (
                <GenerateExcel
                    ...
                    namafile={`v3_EXCELL_BELANJA_KEWILAYAHAN_JENIS_${jenlap}_${moment().format(
                        "DDMMYY-HHmmss"
                    )}.xlsx`}
                />
            )}
            ...
            <SaveUserData userData={telp} menu="belwil" />
        </>
    );
};

export default BelanjaWilayah;