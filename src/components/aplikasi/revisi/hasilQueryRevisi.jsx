  ...
  const getData = async () => {
    ...
    try {
      const response = await axiosJWT.get(
        import.meta.env.VITE_REACT_APP_LOCAL_INQUIRY_GETDATA_REVISI
          ? `${import.meta.env.VITE_REACT_APP_LOCAL_INQUIRY_GETDATA_REVISI
      ...
      // console.log(import.meta.env.VITE_REACT_APP_LOCAL_INQUIRY_GETDATA_REVISI);
...
export default HasilQueryRevisi;
