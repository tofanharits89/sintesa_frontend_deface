...
export default function DetailSatkerKanwil({
  isModalOpen,
  handleModalClose,
  kddept,
  jenis,
  ...
  GROUP BY 
    a.kdsatker 
  ORDER BY 
    a.kddept, a.kdsatker DESC 
  LIMIT 30 OFFSET ${offset}`;
      // console.log(
      //   `SELECT a.kdsatker,a.nmsatker,b.kddept,b.nmdept FROM spending_review.ref_satker_dipa_2025 a left join dbref.t_dept_2025 b on a.kddept=b.kddept left join dbref.t_kppn_2025 c on a.kdkppn=c.kdkppn WHERE c.kdkanwil='${kddept}' AND STATUS='${
      //     jenis === 2 ? "true" : "false"
      //   }' ${limitakses} ORDER BY a.kddept,kdunit,kdsatker,a.kdlokasi,c.kdkppn DESC LIMIT 30 OFFSET ${offset}`
      // );
      const cleanedQuery = decodeURIComponent(encryptedQuery)
        .replace(/\n/g, " ")
        .replace(/\s+/g, " ")
        .trim();
