...
export default function DataTupDetail(props) {
  ...
  const getData = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      `SELECT a.id,a.thang,a.kdsatker,a.tgpermohonan, a.nopermohonan,a.notup,a.tgtup,a.niltup,a.status FROM  laporan_2023.dispensasi_tup_lampiran a WHERE a.id_dispensasi='${props.id}' GROUP BY a.id ORDER BY id DESC`
    );
