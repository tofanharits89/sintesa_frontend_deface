...
import RekonDetail from "./rekondetail";
...
const Rekon = () => {
  ...
  const generateDataRekon = async () => {
    ...
    try {
      const response = await axiosJWT.get(
        import.meta.env.VITE_REACT_APP_LOCAL_GENERATEDATA_REKON
          ? `${
              import.meta.env.VITE_REACT_APP_LOCAL_GENERATEDATA_REKON
            }${username}`
          : "",
  ...
  const DeleteData = async () => {
    ...
    try {
      const response = await axiosJWT.delete(
        import.meta.env.VITE_REACT_APP_LOCAL_TRUNCATEDATAOMSPAN
          ? `${import.meta.env.VITE_REACT_APP_LOCAL_TRUNCATEDATAOMSPAN}`
          : "",
        {
          headers: {
  ...
  const getData = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      ...
      a.tunda,a.cabut,a.potongan,a.salur,b.periode as beda FROM tkd.rekap a left join data_omspan.data_beda b on a.kdpemda=b.kdpemda 
  ...
  const getDataupdate = async () => {
    try {
      const response = await axiosJWT.get(
        import.meta.env.VITE_REACT_APP_LOCAL_UPDATEREKON
          ? `${
              import.meta.env.VITE_REACT_APP_LOCAL_UPDATEREKON
            }?user=${username}`
          : "",
    ...
    try {
      ...
      while (startIndex < totalRows) {
        ...
        const response = await axiosJWT.post(
          `${import.meta.env.VITE_REACT_APP_LOCAL_SIMPANPEMOTONGAN}`,
          batchDatapotong,
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const simpanPenundaan = async () => {
    try {
      ...
      while (startIndex < totalRows) {
        ...
        const response = await axiosJWT.post(
          `${import.meta.env.VITE_REACT_APP_LOCAL_SIMPANPENUNDAANOMSPAN}`,
          batchData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
