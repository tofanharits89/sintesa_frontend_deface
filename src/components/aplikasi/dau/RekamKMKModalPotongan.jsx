...
const RekamKMKModalPotongan = ({ show, onHide, nokmk }) => {
  ...
  const getData = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      `SELECT a.id, a.thang, a.NMBULAN, a.no_kmk, a.kdkppn, a.bulan, a.kdakun, a.kdsatker, a.kdlokasi, a.kriteria, a.kdkabkota, a.nilai nilai, b.nmpemda, b.nmkppn
        ...
        LEFT JOIN tkd.m_dau_24 b ON a.kdkppn = b.kdkppn AND a.kdkabkota = b.kdpemda
...
export default RekamKMKModalPotongan;
