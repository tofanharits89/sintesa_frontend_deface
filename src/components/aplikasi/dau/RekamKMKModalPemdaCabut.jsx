...
export default function DataPemdaCabut({ show, onHide, nokmk, thang }) {
  ...
  const getData = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      `SELECT a.no_kmk,a.tgl_kmk,a.no_kmkcabut,a.tglcabut,nm_kriteria,nmjenis,a.kdkppn,a.kdpemda,d.nmkppn,d.nmpemda FROM tkd.ref_kmk_dau a
      LEFT OUTER JOIN ( SELECT b.jenis,b.nmjenis AS nmjenis FROM tkd.ref_kmk b) b ON a.jenis=b.jenis 
      LEFT OUTER JOIN ( SELECT c.id_kriteria,c.nm_kriteria AS nm_kriteria FROM tkd.ref_kmk_dau_kriteria c) c  ON a.kriteria=c.id_kriteria 
      LEFT OUTER JOIN ( SELECT d.kdkppn,d.kdpemda,d.nmkppn,d.nmpemda FROM tkd.alokasi_bulanan d) d ON a.kdkppn=d.kdkppn AND a.kdpemda=d.kdpemda
