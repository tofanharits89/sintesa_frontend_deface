...
export default function DataKmkCabut(props) {
  ...
  const getData = async () => {
    ...
    const encodedQuery = encodeURIComponent(
      `SELECT a.kmktunda,a.thangcabut,a.no_kmkcabut,a.tglcabut,a.uraiancabut FROM tkd.ref_kmk_cabut a ORDER BY a.id DESC`
    );
