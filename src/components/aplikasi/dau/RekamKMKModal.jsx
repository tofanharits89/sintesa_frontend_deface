...
import Kdkmk from "../../referensi/referensi_dau/ref_kmk";
import Kdkriteria from "../../referensi/referensi_dau/ref_kriteria";
import RefPenundaan from "../../referensi/referensi_dau/ref_penundaan";
import RefPencabutan from "../../referensi/referensi_dau/ref_pencabutan";
...
const RekamKMKModal = ({ show, onHide }) => {
  ...
  const handleSubmitdata = async (values, { setSubmitting }) => {
    ...
    const apiUrl =
      values.jenis === "3"
        ? import.meta.env.VITE_REACT_APP_LOCAL_SIMPANKMKJENIS3
        : import.meta.env.VITE_REACT_APP_LOCAL_SIMPANKMK;
