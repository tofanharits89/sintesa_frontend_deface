...
export default function PenyerapanMBGBenchmark() {
    ...
    if (active && payload && payload.length) {
      ...
      return (
        ...
        >
          ...
          <p
            style={{ margin: "2px 0 0 0", color: "#38bdf8", fontSize: "11px" }}
          >
  ...
  return (
    ...
    >
      ...
      {/* Dropdown Regional & Download Icon */}
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <button
          onClick={() => {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, "Penyerapan MBG");
            XLSX.writeFile(workbook, "penyerapan_mbg.xlsx");
          }}
          style={{
            background: "none",
            border: "none",
      ...
      {/* Chart Content - Minimalist & Compact */}
      {loading ? (
        <div
          style={{
            display: "flex",
        ...
        <div style={{ height: "260px" }}>
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Bar dataKey="penyerapan" fill="#1e40af" radius={[3, 3, 0, 0]}>
                <LabelList
                  dataKey="penyerapan"
                  position="top"
                  style={{
      ...
      {!loading && !error && chartData.length > 0 && (
        ...
        >
          Menampilkan {chartData.length} wilayah dengan penyerapan anggaran
          tertinggi
