...
import { Tgupdate } from "../../aplikasi/inquiry/hasilQuery";
  ...
  const getData = async () => {
    ...
    try {
      const response = await axiosJWT.get(
        import.meta.env.VITE_REACT_APP_LOCAL_INQUIRY_GETDATA_RKAKL
          ? `${
              import.meta.env.VITE_REACT_APP_LOCAL_INQUIRY_GETDATA_RKAKL
...
export default HasilQueryRkakl;
