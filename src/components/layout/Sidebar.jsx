                    ...
                    >
                      ...
                      <li>
                        <Link
                          ...
                          className={` ${darkMode ? "text-white" : ""} ${
                            activeSubmenu === "update-belwil" ? "active" : ""
                          }`}
                        >
                          <i className="bi bi-circle"></i>
                        ...
                        >
                          <li>
                            <Link
                              ...
                              onClick={() =>
                                handleSubmenuClick("data-spending")
                              }
                              className={` ${darkMode ? "text-white" : ""} ${
                                activeSubmenu === "data-spending"
                                  ? "active"
                                  : ""
                              }`}
                            >
                          ...
                          <li>
                            <Link
                              ...
                              onClick={() =>
                                handleSubmenuClick("data-formalokasi")
                              }
                              className={` ${darkMode ? "text-white" : ""} ${
                                activeSubmenu === "data-formalokasi"
                                  ? "active"
                                  : ""
                              }`}
                            >
                          ...
                          <li>
                            <Link
                              ...
                              onClick={() =>
                                handleSubmenuClick("data-monitoring")
                              }
                              className={` ${darkMode ? "text-white" : ""} ${
                                activeSubmenu === "data-monitoring"
                                  ? "active"
                                  : ""
                              }`}
                            >
                              ...
                              <>
                                <li>
                                  <Link
                                    ...
                                    onClick={() =>
                                      handleSubmenuClick("data-tpid")
                                    }
                                    className={` ${
                                      darkMode ? "text-white" : ""
                                    } ${
                                      activeSubmenu === "data-tpid"
                                        ? "active"
                                        : ""
                                    }`}
                                  >
                              ...
                              <>
                                <li>
                                  <Link
                                    ...
                                    onClick={() =>
                                      handleSubmenuClick("data-wr")
                                    }
                                    className={` ${
                                      darkMode ? "text-white" : ""
                                    } ${
                                      activeSubmenu === "data-wr"
                                        ? "active"
                                        : ""
                                    }`}
                                  >
                              ...
                              <>
                                <li>
                                  <Link
                                    ...
                                    onClick={() =>
                                      handleSubmenuClick("monev_pnbp")
                                    }
                                    className={` ${
                                      darkMode ? "text-white" : ""
                                    } ${
                                      activeSubmenu === "monev_pnbp"
                                        ? "active"
                                        : ""
                                    }`}
                                  >
                      ...
                      >
                        <li>
                          <Link
                            ...
                            onClick={() =>
                              handleSubmenuClick("data-dispensasi")
                            }
                            className={` ${darkMode ? "text-white" : ""} ${
                              activeSubmenu === "data-dispensasi"
                                ? "active"
                                : ""
                            }`}
                          >
                          ...
                          <>
                            <li>
                              <Link
                                ...
                                onClick={() =>
                                  handleSubmenuClick("data-referensi")
                                }
                                className={` ${darkMode ? "text-white" : ""} ${
                                  activeSubmenu === "data-referensi"
                                    ? "active"
                                    : ""
                                }`}
                              >
                            ...
                            <li>
                              <Link
                                ...
                                to="/v3/rowset/"
                                onClick={() =>
                                  handleSubmenuClick("data-subsidi")
                                }
                                className={` ${darkMode ? "text-white" : ""} ${
                                  activeSubmenu === "data-subsidi"
                                    ? "active"
                                    : ""
                                }`}
                              >
                            ...
                            <li>
                              <Link
                                ...
                                to="/v3/track/nadine"
                                onClick={() =>
                                  handleSubmenuClick("data-nadine")
                                }
                                className={` ${darkMode ? "text-white" : ""} ${
                                  activeSubmenu === "data-nadine"
                                    ? "active"
                                    : ""
                                }`}
                              >
                        ...
                        {role !== "2" && (
                          <li>
                            <Link
                              ...
                              onClick={() =>
                                handleSubmenuClick("data-proyeksi")
                              }
                              className={` ${darkMode ? "text-white" : ""} ${
                                activeSubmenu === "data-proyeksi"
                                  ? "active"
                                  : ""
                              }`}
                            >
                        ...
                        {(role === "0" || role === "1" || role === "X") && (
                          <li>
                            <Link
                              ...
                              onClick={() =>
                                handleSubmenuClick("data-penilaian")
                              }
                              className={` ${darkMode ? "text-white" : ""} ${
                                activeSubmenu === "data-penilaian"
                                  ? "active"
                                  : ""
                              }`}
                            >
